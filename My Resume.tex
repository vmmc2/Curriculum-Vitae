...
\subsection{UFPE - Universidade Federal \newline de Pernambuco}
\descript{B.Sc. in Computer Engineering}
\location{Feb. 2018 - Dec. 2022 (expected)}
%\location{Cum. GPA: 8.93/10.00}
...
\textbullet{}\location{Software Engineering}
...
\location{1-2 years:}
 Dart \newline
\location{Less than 1 year:}
JavaScript \textbullet{}  HTML \textbullet{} CSS \textbullet{} Haskell \newline \texbullet{} Java \textbullet{} Latex
\vspace{3mm} %5mm vertical space
...
Flutter \textbullet{} Bootstrap \textbullet{} Bulma
\vspace{3mm}
...
\subsection{Awards}
\textbullet \location{3rd Place (in Brazil) - Google Hashcode (2021)}
\textbullet \location{3rd Place - 2D Simulation Category in Brazilian Robotics Competition/CBR (2020)}
\textbullet \location{4th Place - Microsoft Hackathon "Bot-A-ndo" a mão na massa (2019)}
...
\location{Nov. 2019 — Jan. 2021 | Recife - PE, BR}
